-- ORGANIZATECH PERF-06 — PRODUCCIÓN — ACL/FUNCTION CLASSIFICATION READ-ONLY
...
evaluation as (
  select case
    ...
    when overall.item_count <> 346
      ...
      or (select sha256 from category_hashes where category = 'function') <> 'ac9f9145327f35a7c186d8e1aec5adeb0ca0495f46cc718fb1c965b231308ffb'
      or (select sha256 from category_hashes where category = 'table_acl') <> 'fe60fd8b07cf9ca0dbcb4eab09e49dda446d8e2e3240b62e6d2623aadccb5b39'
