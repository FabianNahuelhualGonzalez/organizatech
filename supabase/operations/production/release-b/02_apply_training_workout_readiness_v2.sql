-- Release B - Production controlled application for workout readiness v2.
-- Project ref: lzycxltqbrtsnwfdotqw.
-- Execute manually only after 01_precheck_readonly.sql returns PROD_READINESS_V2_READY.
-- Frontend remains legacy in this phase; this script only installs backend v2 objects.
-- Source migration: supabase/migrations/20260620_training_workout_readiness.sql.
-- No test data, UUIDs, payloads, training sessions or exercise entries are inserted by this wrapper.
