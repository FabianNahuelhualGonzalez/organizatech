...
export type OptionalYouTubeVideoUrlValidation =
...
/**
 * Contrato único para formulario, dominio, transporte y ejecución.
 * Sólo admite HTTPS de YouTube y elimina parámetros de seguimiento.
 */
export function validateOptionalYouTubeVideoUrl(
  value: string,
): OptionalYouTubeVideoUrlValidation {
...
export function isSupportedYouTubeVideoUrl(value: string): boolean {
  const result = validateOptionalYouTubeVideoUrl(value);
